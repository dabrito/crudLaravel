      ...
      <div class="col-8">
        ...
        <form action="{{ route('projects.store')}}" method="POST">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="titulo" id="titulo" class="form-control" aria-label="Ingrese Titulo" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group">
            <span class="input-group-text">Descripcion</span>
            <textarea name="descripcion" id="descripcion" class="form-control" aria-label="Ingrese una Descripcion"></textarea>
          </div>
          <div>
            <hr>
